...
class KnowledgeBase:
    ...
    def load_places(self) -> List[Dict[str, Any]]:
        """Load semua data tempat wisata dari database tanpa filter"""
    ...
    def load_rules(self):
        ...
        # Aturan akan mengupdate self.facts berdasarkan kondisi
        self.rules = [
            {
                "name": "lokasi_cocok",
    ...
    def rule_lokasi_cocok(self, user_facts, places):
        # Jika user tidak input lokasi, anggap semua cocok
        for place in places:
            cocok = False
        ...
        try:
            ...
            if recommendations:
                ...
                for rec in recommendations:
                    ...
                    print(f"  Lokasi: {rec.get('maps', 'N/A')}")
